...
public class AccountController {
	...
	@GetMapping("")
	public String getAllUserAccounts (ModelMap model, @PathVariable Long userId) {
	User existingUser = userService.findByIdWithAccounts(userId);
	List<Account> userAccounts = existingUser.getAccounts();
	model.put("accounts", userAccounts);
